    ...
    <div>
      {!loading ? (
                ...
                <div className="flex lg:mx-20 mx-8 py-32 md:pt-32 md:pb-10 flex-col items-center min-h-[100dvh]">
                  <div className="max-w-xl w-full flex flex-col mx-8 my-3">
                    <div className="text-2xl mb-5 font-semibold">
                      <p>Profile</p>
                      <div className="w-full mt-2 rounded-full h-1 mr-2 bg-gradient-to-r from-[#bb0486] via-[#f8914c] to-background" />
                    </div>
                  ...
                  .map((profile) => (
                    ...
                    >
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <div className="max-w-xl flex flex-col justify-center items-center mx-8 mt-3">
                          <div className="flex w-full justify-center mt-3 items-center max-w-md">
                             <div className="text-xl">{profile.name}</div>
                          </div>
                          <p className="sm:max-w-md my-3 text-center">
                            {profile.bio}
        ...
        <div className="max-w-xl flex flex-col justify-center items-center">
          <div className="flex w-full justify-center items-center max-w-md">
            <img className="loading-img" src="/fast-bio.png" alt="" />
          </div>
